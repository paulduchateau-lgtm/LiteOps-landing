    ...
    <div className="bg-architect-paper min-h-screen">
      ...
      <section className="relative overflow-hidden border-b border-rule">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/photos/photo-1676634211486-181d8fdc5b9a.avif"
            alt="Café et outils — l'atelier au quotidien"
            fill
            priority
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-16 items-start">
              ...
              <div className="space-y-6">
                ...
                >
                  <Image
                    src="/photos/photo-1713281318607-c0fbfc96d58c.avif"
                    alt="Console technique — opérateurs et contrôle"
                    fill
